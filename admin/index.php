                ...
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                       ...
                       <?php 
                        ...
                        echo "<div class='huge'>{$categorie_count}</div>";
                        ?>
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Data', 'Count'],
            ...
            $element_count = [$post_count, $published_post_count, $draft_post_count, $comment_count, $unapproved_comment_count, $user_count, $subscriber_count, $categorie_count];
